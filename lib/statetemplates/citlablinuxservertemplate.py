from citlinuxservertemplate import CITLinuxServerTemplate


class CitLabLinuxServerTemplate(CITLinuxServerTemplate):
    """
    Set:
    exists
    name
    ...
    def __init__(self, record=None, username=None, password=None, url=None,  priority=30, productionstate=None,
        ...
        super(CitLabLinuxServerTemplate, self).__init__(record, username, password, url, priority,
